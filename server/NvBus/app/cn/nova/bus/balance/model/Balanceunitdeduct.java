 ...
 */
@Entity
public class Balanceunitdeduct {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name = "BALANCEUNIT_ID_GENERATOR", sequenceName = "SEQ_BALANCE", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "BALANCEUNIT_ID_GENERATOR")
	private long id;
