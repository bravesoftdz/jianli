...
/**
 * The persistent class for the ORGDAYNEEDBALANCE database table.
 * 
 */
@Entity
public class Orgdayneedbalance implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="ORGDAYNEEDBALANCE_ID_GENERATOR", sequenceName="SEQ_BALANCE")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="ORGDAYNEEDBALANCE_ID_GENERATOR")
	private long id;
