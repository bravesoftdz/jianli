...
/**
 * The persistent class for the FORMULAITEMROADGRADE database table.
 * 
 */
@Entity
public class Formulaitemroadgrade implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="FORMULAITEMROADGRADE_ID_GENERATOR", sequenceName="SEQ_PUB",allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="FORMULAITEMROADGRADE_ID_GENERATOR")
	private long id;
