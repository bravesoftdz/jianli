...
/**
 * The persistent class for the FORMULAITEMROUTE database table.
 * 
 */
@Entity
public class Formulaitemroute implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="FORMULAITEMROUTE_ID_GENERATOR", sequenceName="SEQ_PUB",allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="FORMULAITEMROUTE_ID_GENERATOR")
	private long id;
