...
@DelphiDS
public class TicketreturnQueryVo {
	...
	private BigDecimal cashreturnprice;//现金退款金额
	
	private BigDecimal nocashreturnprice;//电子退款金额

	private BigDecimal nochargesnocashprice;//未扣手续费前的原路退还金额
	
	private BigDecimal nocashinsureprice;//原路退还保险金额
	...
	public BigDecimal getCashreturnprice() {
		return cashreturnprice;
	}

	public void setCashreturnprice(BigDecimal cashreturnprice) {
		this.cashreturnprice = cashreturnprice;
	}

	public BigDecimal getNocashreturnprice() {
		return nocashreturnprice;
	}

	public void setNocashreturnprice(BigDecimal nocashreturnprice) {
		this.nocashreturnprice = nocashreturnprice;
	}

	public BigDecimal getNochargesnocashprice() {
		return nochargesnocashprice;
	}

	public void setNochargesnocashprice(BigDecimal nochargesnocashprice) {
		this.nochargesnocashprice = nochargesnocashprice;
	}

	public BigDecimal getNocashinsureprice() {
		return nocashinsureprice;
	}

	public void setNocashinsureprice(BigDecimal nocashinsureprice) {
		this.nocashinsureprice = nocashinsureprice;
	}
