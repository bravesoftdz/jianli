...
public class AutoGateDESUtil {
    ...
    public static void main(String[] args) {
    	//待加密内容  
    	String str = "127.0.0.1989811420114199211085159";
    	//密码，长度要是8的倍数  
    	String password = "bus36501";
    	String result = null;
		try {
			result = AutoGateDESUtil.generateEncrypt(str, password);
		} catch (Exception e) {
			e.printStackTrace();
		}
