...
public class ServiceStarter extends Job{
	private static final String SPROPERTY_FILE_NAME = "AutoGateService.properties";
	...
	public void doJob() {
		...
		roperties_file = getClass().getResourceAsStream(SPROPERTY_FILE_NAME);
		if (roperties_file == null) {
			MsgHelper.logger("未找到配置：" + SPROPERTY_FILE_NAME + "，初始化失败。");
		} else {
