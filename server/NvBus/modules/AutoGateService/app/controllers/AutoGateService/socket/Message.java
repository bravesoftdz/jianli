...
public class Message {
	...
	private String gateplacetype; //闸机使用场景类型    未设置/0：检票口上车;   1：侯车厅进站  
	...
	public void setTicketno(String ticketno) {
		...
		if(ticketno!=null){
			this.ticketno = this.ticketno.replaceAll("[*]", "");
		}
	}
	...
	public String getGateplacetype() {
		return gateplacetype;
	}

	public void setGateplacetype(String gateplacetype) {
		this.gateplacetype = gateplacetype;
	}
