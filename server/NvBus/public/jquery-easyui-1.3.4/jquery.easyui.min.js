...
$.fn.validatebox.defaults={required:false,validType:null,delay:200,missingMessage:"必填字段.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
...
},message:"请输入正确的邮箱地址."},url:{validator:function(_409){
...
},message:"请输入一个{0}到{1}位的字符串."},remote:{validator:function(_40c,_40d){
var data={};
data[_40d[1]]=_40c;
