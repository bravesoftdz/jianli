...
def readpid():
    ...
    try:
        all_the_text="0"
        file_object = open('//app//play-1.2.3//NvBus//server.pid')
        print "open file ok"
...
def checkandprintstack():
    ...
    while(True):
        if j==0:
            j=j+1
            pid=readpid()
            commandstring="jstack -l " + pid + " >>//app//play-1.2.3//NvBus//checkport-start.log"
            print commandstring
            try:
        ...
        if checkurl()==1:
            ...
            if int(pid)>0 :
                ...
                if i==200:
                    i=0
                commandstring1="date  >> //app//play-1.2.3//NvBus//checkport" + str(i) + ".log"
                commandstring="jstack -l " + pid + " >> //app//play-1.2.3//NvBus//checkport" + str(i) +".log"
                i=i+1
                print commandstring
                try:
