...
type
  TfrmPersellSum  = class(TSimpleCRUDForm)
    pnl1: TPanel;
    grp1: TGroupBox;
...
procedure TfrmPersellSum.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TfrmPersellSum.tbtnFilterClick(Sender: TObject);
var log : string;
begin
  inherited;
...
with jcdsResult do
  begin
    ...
    begin
      ...
      begin
         Params.ParamValues['filter_EQB_s!isovertime']:='';
      end;
    Active:= true;
    ...
    SysLog.WriteLog('综合查询->班次预售情况汇总表','查询',log);
  end;
end ;
end.
