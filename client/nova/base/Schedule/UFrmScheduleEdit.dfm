inherited FrmSchdeuleEdit: TFrmSchdeuleEdit
  Caption = 'FrmSchdeuleEdit'
  ClientHeight = 575
  ClientWidth = 744
  OnCreate = FormCreate
  ExplicitWidth = 750
  ...
  inherited pnlEditBox: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 56
      Height = 14
      Caption = #22987#21457#26102#38388
    end
    ...
    object Label26: TLabel
      ...
      Width = 84
      Height = 14
      Caption = #26411#29677#21457#36710#26102#38388
    end
    object Label29: TLabel
      ...
      Width = 56
      Height = 14
      Caption = #20998#38047#19968#29677
    end
    object lbl1: TLabel
      Left = 629
      Top = 56
    ...
    object Label23: TLabel
      ...
      Width = 70
      Height = 14
      Caption = #39550#39542#21592#20154#25968
      Visible = False
    end
    ...
    object ChkISLINEWORK: TCheckBox
      ...
      Width = 132
      Height = 17
      Caption = #27969#27700#29677#27425', '#27599#38548
      TabOrder = 12
      OnClick = ChkISLINEWORKClick
    end
    ...
    object NEdtVIASTATION: TNovaEdit
      Left = 114
      Top = 351
      Width = 407
      Height = 22
    ...
    object NovaEdtSpacinginterval: TNovaEdit
      Left = 584
      Top = 148
      Width = 42
      Height = 22
    ...
    object chkEditAll: TCheckBox
      Left = 567
      Top = 318
      Width = 177
      Height = 17
      Caption = #21516#26102#20462#25913#20854#20182#29677#27425
      TabOrder = 21
    end
    object Chkisfixseat: TCheckBox
      Left = 567
      Top = 188
      Width = 100
      Height = 17
      Hint = #26159#21542#26159#22266#23450#24231#20301#29677#27425#65292#33509#20026#22266#23450#24231#20301#65292#25253#21040#26102#19981#38543#36710#36742#24231#20301#25968#32780#21464#21270
      Caption = #22266#23450#24231#20301#25968
      Checked = True
    ...
    object Cbxisneed: TCheckBox
      ...
      TabOrder = 27
      OnClick = CbxisneedClick
    end
    object NvedtDrivernum: TNovaEdit
      Left = 623
      Top = 386
      Width = 42
      Height = 22
    ...
    object ChbPrintDepartTiime: TCheckBox
      Left = 537
      Top = 424
      Width = 100
      Height = 17
      Caption = #25171#21360#21457#36710#26102#38388
      Checked = True
      State = cbChecked
      TabOrder = 31
    end
  ...
  object jsonCDSSaveSchedule: TjsonClientDataSet
    DataSourceName = 'dataSet'
    QueryAddress = 'base/query'
    SaveAddress = 'base/saveschedule'
    AutoActive = False
    ...
    Params = <
      ...
      item
        DataType = ftBoolean
        Name = 'schedule.isneedfinger'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'schedule.driverfingernum'
        ParamType = ptInput
      end
      item
        DataType = ftString
