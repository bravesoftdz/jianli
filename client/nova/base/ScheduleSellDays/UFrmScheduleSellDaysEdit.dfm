inherited frmScheduleSellDaysEdit: TfrmScheduleSellDaysEdit
  Caption = #32534#36753#29677#27425#39044#21806#22825#25968#25511#21046
  ClientHeight = 380
  ClientWidth = 641
  OnCreate = FormCreate
  ExplicitWidth = 647
  ...
  inherited ImageList: TImageList
    Top = 240
    Bitmap = {
      494C0101050007009C0018001800FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object jsdcSave: TjsonClientDataSet
    DataSourceName = 'scheduleperselldays'
    QueryAddress = 'base/saveperselldays'
    SaveAddress = 'base/saveperselldays'
    AutoActive = False
    ...
    Params = <
      item
        DataType = ftString
        Name = 'scheduleperselldays.id'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'scheduleperselldays.orgid'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'scheduleperselldays.perserlldays'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'scheduleperselldays.type'
        ParamType = ptInput
      end
      item
        DataType = ftString
      ...
      item
        DataType = ftString
        Name = 'scheduleperselldays.createby'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'scheduleperselldays.createtime'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'scheduleperselldays.updateby'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'scheduleperselldays.remarks'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'scheduleperselldays.updatetime'
        ParamType = ptInput
      end
      item
        DataType = ftString
  ...
  object jcdsSchedule: TjsonClientDataSet
    ...
    QueryAddress = 'base/findscheduleRouteinfo'
    AutoActive = False
    AutoCopyRecord = False
    AutoCloneData = False
    Aggregates = <>
