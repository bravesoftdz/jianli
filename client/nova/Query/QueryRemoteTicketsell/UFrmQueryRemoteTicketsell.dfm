inherited frmQueryRemoteTicketsell: TfrmQueryRemoteTicketsell
  Caption = #36828#31243#26816#31080#26597#35810#26597#35810
  ClientHeight = 478
  ClientWidth = 1189
  Position = poDesigned
  ExplicitWidth = 1197
  ...
  inherited pnlQuery: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 56
      Height = 14
      Caption = #26816#31080#26426#26500
    end
    ...
    object nvcbbcheckOrgid: TNovaCheckedComboBox
      Left = 490
      Top = 18
      Width = 127
      Height = 22
    ...
    object nvcbbsellorgid: TNovaCheckedComboBox
      Left = 695
      Top = 18
      Width = 128
      Height = 22
      ...
      inherited dbgrdhResult: TNvDbgridEh
        ...
        Columns = <
          item
            ...
            Footers = <>
            Title.Caption = #21457#36710#26426#26500
            Width = 94
          end
          item
            EditButtons = <>
            ...
            Footers = <>
            Title.Caption = #26816#31080#26426#26500
            Width = 100
          end
          item
            EditButtons = <>
            FieldName = 'checktypevalue'
            Footers = <>
            Title.Caption = #26816#31080#31867#22411
            Width = 80
          end
          item
            EditButtons = <>
  ...
  inherited ilToolBar: TImageList
    ...
    Top = 360
    Bitmap = {
      494C01013A003C00900118001800FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  inherited jcdsResult: TjsonClientDataSet
    DataSourceName = 'remoteticketsellmap'
    QueryAddress = 'query/queryrRemoteticketsell'
    SaveAddress = 'query/findticketSellQry'
    Params = <
      item
        DataType = ftString
        Name = 'filter_INS_rt!departorgid'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'filter_EQS_rt!schedulecode'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'filter_EQS_rt!ticketno'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'filter_GED_rt!departdate'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'filter_LED_rt!departdate'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'filter_EQL_rt!departstationid'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'filter_EQL_rt!reachstationid'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'filter_GED_rt!selltime'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'filter_LED_rt!selltime'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'filter_EQS_rt!tickettype'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'filter_EQS_rt!ticketstatus'
        ParamType = ptInput
      end
      item
        DataType = ftString
      ...
      item
        DataType = ftString
        Name = 'filter_INS_rt!checkorgid'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'filter_INS_rt!ticketsellorgid'
        ParamType = ptInput
      end>
    Left = 256
    Top = 312
    ...
    object jcdsResultdiscountrate: TFloatField
      FieldName = 'discountrate'
    end
    ...
    object jcdsResultbatchno: TWideStringField
      FieldName = 'batchno'
      Size = 0
    end
    object jcdsResulttoplimitprice: TFloatField
      FieldName = 'toplimitprice'
    end
    ...
    object jcdsResultseattypevalue: TWideStringField
      FieldKind = fkLookup
      FieldName = 'seattypevalue'
      LookupDataSet = jsonSeattype
      LookupKeyFields = 'code'
      LookupResultField = 'value'
      KeyFields = 'seattYPE'
      Size = 90
    ...
    object jcdsResultchecktype: TWideStringField
      FieldName = 'checktype'
      Size = 80
    end
    ...
    object jcdsResultsubtotal: TFloatField
      FieldName = 'subtotal'
    end
    ...
    object jcdsResultcorgname: TWideStringField
      FieldName = 'corgname'
      Size = 80
    end
    object jcdsResultchecktypevalue: TWideStringField
      FieldKind = fkLookup
      FieldName = 'checktypevalue'
      LookupDataSet = jcdsCheckType
      LookupKeyFields = 'code'
      LookupResultField = 'value'
      KeyFields = 'checktype'
      Size = 80
  ...
  object jsonSeattype: TjsonClientDataSet
    DataSourceName = 'diclist'
    QueryAddress = 'system/querydictionary'
    AutoActive = False
    AutoCopyRecord = False
  ...
  object jcdsCheckType: TjsonClientDataSet
    DataSourceName = 'diclist'
    QueryAddress = 'system/querydictionary'
    AutoActive = False
    AutoCopyRecord = False
