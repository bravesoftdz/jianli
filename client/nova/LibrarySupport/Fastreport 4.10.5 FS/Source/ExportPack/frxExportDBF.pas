...
procedure TfrxDBFExport.ExportMatrix( Stream: TStream; mx: TfrxIEMatrix );
 ...
 function StrToOem(const AnsiStr: AnsiString): AnsiString;
  ...
  procedure ByteCopy( dest, src: Pointer; n: LongWord ); cdecl;
  label
    read, done;
  asm
    push  esi
...
begin
  ...
  begin
    ...
    begin
      ...
      if s <> '' then
        ByteCopy( @buffer[1], @s[1], MaxFieldLen );
...
begin
  ...
  try
    ...
    MessageBox( Handle, @WideString(frxGet(9104))[1], @WideString(frxGet(9105))[1],
