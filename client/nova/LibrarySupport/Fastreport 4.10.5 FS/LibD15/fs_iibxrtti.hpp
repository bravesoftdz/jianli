...
// (DO NOT EDIT: machine generated header) 'fs_iibxrtti.pas' rev: 22.00
...
class PASCALIMPLEMENTATION TfsIBXRTTI : public Classes::TComponent
{
	typedef Classes::TComponent inherited;
	
public:
	/* TComponent.Create */ inline __fastcall virtual TfsIBXRTTI(Classes::TComponent* AOwner) : Classes::TComponent(AOwner) { }
