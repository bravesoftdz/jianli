...
// (DO NOT EDIT: machine generated header) 'frxRichEdit.pas' rev: 22.00
...
{
//-- type declarations -------------------------------------------------------
typedef System::ShortInt TRichEditVersion;
...
typedef System::ShortInt THeadingStyle;
...
public:
	virtual int __fastcall ConvertReadStream(Classes::TStream* Stream, System::DynamicArray<System::Byte> Buffer, int BufSize);
	virtual int __fastcall ConvertWriteStream(Classes::TStream* Stream, System::DynamicArray<System::Byte> Buffer, int BufSize);
public:
