...
// (DO NOT EDIT: machine generated header) 'Fs_synmemo.pas' rev: 21.00
...
enum TSyntaxType { stPascal, stCpp, stJs, stVB, stSQL, stText };
#pragma option pop

#pragma option push -b-
enum TCharAttr { caNo, caText, caBlock, caComment, caKeyword, caString };
#pragma option pop

typedef Set<TCharAttr, caNo, caString>  TCharAttributes;

class DELPHICLASS TfsSyntaxMemo;
class PASCALIMPLEMENTATION TfsSyntaxMemo : public Controls::TCustomControl
{
	typedef Controls::TCustomControl inherited;
	
private:
	typedef DynamicArray<int> _TfsSyntaxMemo__1;
...
public:
	__fastcall virtual TfsSyntaxMemo(Classes::TComponent* AOwner);
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TfsSyntaxMemo(HWND ParentWindow) : Controls::TCustomControl(ParentWindow) { }
	
};


class DELPHICLASS TfsSynMemoSearch;
class PASCALIMPLEMENTATION TfsSynMemoSearch : public Forms::TForm
{
...
public:
	/* TCustomForm.Create */ inline __fastcall virtual TfsSynMemoSearch(Classes::TComponent* AOwner) : Forms::TForm(AOwner) { }
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfsSynMemoSearch(Classes::TComponent* AOwner, int Dummy) : Forms::TForm(AOwner, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TfsSynMemoSearch(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfsSynMemoSearch(HWND ParentWindow) : Forms::TForm(ParentWindow) { }
	
};


//-- var, const, procedure ---------------------------------------------------
extern PACKAGE TfsSynMemoSearch* SynMemoSearch;
