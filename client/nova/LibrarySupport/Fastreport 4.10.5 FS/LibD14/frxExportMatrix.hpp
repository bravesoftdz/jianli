...
// (DO NOT EDIT: machine generated header) 'Frxexportmatrix.pas' rev: 21.00
...
private:
	typedef DynamicArray<int> _TfrxIEMatrix__1;
...
private:
	...
	bool __fastcall QuickFind(Classes::TList* aList, System::Extended aPosition, int &Index);
	...
	void __fastcall AddPos(Classes::TList* List, System::Extended Value);
...
public:
	...
	void __fastcall AddPage(Printers::TPrinterOrientation Orientation, System::Extended Width, System::Extended Height, System::Extended LeftMargin, System::Extended TopMargin, System::Extended RightMargin, System::Extended BottomMargin, bool MirrorMargins, int Index);
...
public:
	...
	__property Graphics::TMetafileCanvas* MetafileCanvas = {read=FMetafileCanvas, write=FMetafileCanvas};
};
