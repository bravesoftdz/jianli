...
// (DO NOT EDIT: machine generated header) 'Fs_iinterpreter.pas' rev: 21.00
...
public:
	...
	DYNAMIC void __fastcall AddMethod(const System::UnicodeString Syntax, TfsCallMethodNewEvent CallEvent, const System::UnicodeString Category = L"", const System::UnicodeString Description = L"")/* overload */;
	DYNAMIC void __fastcall AddMethod(const System::UnicodeString Syntax, TfsCallMethodEvent CallEvent, const System::UnicodeString Category = L"", const System::UnicodeString Description = L"")/* overload */;
	...
	System::Variant __fastcall CallFunction(const System::UnicodeString Name, const System::Variant &Params);
	System::Variant __fastcall CallFunction1(const System::UnicodeString Name, System::Variant &Params);
	System::Variant __fastcall CallFunction2(const TfsProcVariable* Func, const System::Variant &Params);
	...
	bool __fastcall IsExecutableLine(int LineN, const System::UnicodeString UnitName = L"");
