namespace CustFuncDemo1
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.richTextBox1.Text = "本程序演示通过响应AcRptEngine.OnFunction事件添加自定义函数。\n主要有两个步骤：\n1.调用AcRptEngine.AddFunctionNam" +
                "e加入函数的描述\n2.响应OnFunction事件，编写函数处理代码";
            // 
            // button1
            // 
            ...
            this.Text = "AC Report扩充自定义函数1(C#.net)";
