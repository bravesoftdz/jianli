...
// PASTLWTR : 1.2
// File generated on 2011-01-13 2:26:23 from Type Library described below.
...
// *********************************************************************//
  IAcWebClientView = interface(IDispatch)
    ...
    function LoadAptFromURL(const URL: WideString): HResult; safecall;
    function LoadAptFromFile(const FileName: WideString): HResult; safecall;
...
// *********************************************************************//
  IAcWebClientViewDisp = dispinterface
    ...
    function LoadAptFromURL(const URL: WideString): HResult; dispid 250;
    function LoadAptFromFile(const FileName: WideString): HResult; dispid 251;
  end;
...
// *********************************************************************//
  ...
  public
    ...
    function LoadAptFromURL(const URL: WideString): HResult;
    function LoadAptFromFile(const FileName: WideString): HResult;
...
function TAcWebClientView.LoadAptFromURL(const URL: WideString): HResult;
begin
  Result := DefaultInterface.LoadAptFromURL(URL);
end;

function TAcWebClientView.LoadAptFromFile(const FileName: WideString): HResult;
begin
  Result := DefaultInterface.LoadAptFromFile(FileName);
end;
