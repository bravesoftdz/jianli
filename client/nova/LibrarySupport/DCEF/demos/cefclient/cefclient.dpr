...
//  TExtension = class(TCefV8ContextHandlerOwn)
//
//  end;
...
//  TCefv8ValueRef.CreateFunction('myfunc',TExtension.Create as ICefV8Handler);
//  IMPLEMENT_REFCOUNTING(MyV8Handler);
  //navigateto := 'client://test/';
  //navigateto := 'file://c:\';
  navigateto := 'file:///C:/svn_nova/DCEF/bin/Win32/a.htm';
  try
