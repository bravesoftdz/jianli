...
// (DO NOT EDIT: machine generated header) 'Sqldriverediteh.pas' rev: 21.00
...
__published:
	...
	void __fastcall gridParamsColumns0UpdateData(System::TObject* Sender, System::UnicodeString &Text, System::Variant &Value, bool &UseText, bool &Handled);
...
typedef DynamicArray<System::Variant> TParamsArr;
...
public:
	...
	virtual Db::TDataSet* __fastcall CreateReader(System::UnicodeString SQL, TParamsArr FParams);
	...
	virtual int __fastcall Execute(System::UnicodeString SQLText, Datadrivereh::TSQLCommandTypeEh CommandType, const System::Variant &VarParams, Db::TDataSet* &Cursor)/* overload */;
	virtual System::UnicodeString __fastcall GetEngineName(void);
	virtual System::UnicodeString __fastcall GetServerTypeName(void);
	virtual bool __fastcall GetFieldList(const System::UnicodeString TableName, Db::TDataSet* DataSet);
	virtual System::UnicodeString __fastcall GetSpecParamsList(void);
...
public:
	virtual System::UnicodeString __fastcall AccessEngineName(void) = 0 ;
	virtual TDesignDataBaseEh* __fastcall CreateDesignDataBase(Datadrivereh::TCustomSQLDataDriverEh* DataDriver, TCustomDBServiceClass DBServiceClass, System::UnicodeString DataBaseName) = 0 ;
public:
...
typedef System::UnicodeString __fastcall (__closure *TGetTextEvent)(System::TObject* Sender);
...
public:
	...
	bool FNodesLoaded;
	System::UnicodeString FNodesSelect;
	TSQLTreeNodeTemplate* FNodesTemplate;
	System::UnicodeString FObjId;
	TSQLTreeNode* FParent;
	Memtableeh::TMemTableEh* FTable;
	System::UnicodeString FTableFields;
	System::UnicodeString FTableFilter;
	System::UnicodeString FTypeId;
	bool FParentRecordToTableMode;
	TServicePopupParams PopupParams;
...
private:
	System::UnicodeString FName;
	System::UnicodeString FMasterTemplateName;
	System::UnicodeString FNodesMemTableName;
	TParamsArr FParams;
	TCustomDBService* FNodeManager;
	System::UnicodeString FObjIdFieldName;
	System::UnicodeString FInTreeTextFieldName;
	System::UnicodeString FNodesFilter;
	System::UnicodeString FNodesSQLClassName;
	TColumnAttributes FColumnAttributes;
	Controls::TDragDropEvent FOnNodeDragDrop;
	TServicePopupParams FNodeDropMenuParams;
	TServicePopupParams FTableNodeDropMenuParams;
	bool FHasNodes;
	int FSelectedIndex;
	System::UnicodeString FAdditionalLoadSQL;
	System::UnicodeString FColumnAttributesStr;
	System::UnicodeString FAdditionalFielsInfo;
	void __fastcall SetColumnAttributes(const System::UnicodeString Value);
	
public:
	__fastcall TSQLTreeNodeTemplate(TCustomDBService* ANodeManager, System::UnicodeString AName);
	__fastcall virtual ~TSQLTreeNodeTemplate(void);
	virtual TSQLTreeNode* __fastcall CreateNode(void);
	System::UnicodeString __fastcall DropMenuNodeText(System::TObject* Sender);
	System::UnicodeString __fastcall DropMenuNlCommaNodeText(System::TObject* Sender);
	System::UnicodeString __fastcall DropMenuSelectAstFromName(System::TObject* Sender);
	System::UnicodeString __fastcall DropMenuSelectAllFieldsFromName(System::TObject* Sender);
	System::UnicodeString __fastcall DropDataSelectAllFieldsFromName(System::TObject* Sender);
	...
	__property System::UnicodeString NodesSQLClassName = {read=FNodesSQLClassName, write=FNodesSQLClassName};
	__property System::UnicodeString MasterTemplateName = {read=FMasterTemplateName, write=FMasterTemplateName};
	__property System::UnicodeString NodesMemTableName = {read=FNodesMemTableName, write=FNodesMemTableName};
	__property System::UnicodeString ObjIdFieldName = {read=FObjIdFieldName, write=FObjIdFieldName};
	__property System::UnicodeString InTreeTextFieldName = {read=FInTreeTextFieldName, write=FInTreeTextFieldName};
	__property bool HasNodes = {read=FHasNodes, write=FHasNodes, nodefault};
	__property System::UnicodeString NodesFilter = {read=FNodesFilter, write=FNodesFilter};
	__property System::UnicodeString ColumnAttributesStr = {read=FColumnAttributesStr, write=SetColumnAttributes};
	__property System::UnicodeString AdditionalLoadSQL = {read=FAdditionalLoadSQL, write=FAdditionalLoadSQL};
	__property System::UnicodeString AdditionalFielsInfo = {read=FAdditionalFielsInfo, write=FAdditionalFielsInfo};
};
...
private:
	System::UnicodeString FIncremenField;
	System::UnicodeString FIncremenObject;
...
public:
	...
	__property System::UnicodeString IncremenField = {read=FIncremenField, write=FIncremenField};
	__property System::UnicodeString IncremenObject = {read=FIncremenObject, write=FIncremenObject};
...
protected:
	...
	virtual TSQLTreeNode* __fastcall CreateNode(void);
	virtual Db::TDataSet* __fastcall CreateReader(System::UnicodeString SQL, TParamsArr FParams);
	Memtableeh::TMemTableEh* __fastcall GetMemTable(System::UnicodeString TableName);
	TSQLTreeNodeTemplate* __fastcall GetTemplate(System::UnicodeString TemplateName);
	System::UnicodeString __fastcall LoadText(System::UnicodeString TextName);
	...
	System::UnicodeString __fastcall SQLClassTextByName(System::UnicodeString ClassName);
	...
	void __fastcall OnPopupClick(System::TObject* Sender);
	void __fastcall AddSQLClass(System::UnicodeString Name, System::UnicodeString SQLText);
...
public:
	...
	__classmethod virtual System::UnicodeString __fastcall GetDBServiceName();
};
...
public:
	TCustomDBServiceClass DBServiceClass;
	TAccessEngineEh* AccessEngine;
	System::UnicodeString DBName;
public:
...
public:
	TAccessEngineEh* AccessEngine;
	TCustomDBServiceClass DBService;
public:
...
extern PACKAGE System::UnicodeString SqlTextPathFileName;
extern PACKAGE Classes::TStringList* __fastcall GetDBServiceList(void);
extern PACKAGE void __fastcall RegisterDBService(System::UnicodeString ServerName, TCustomDBServiceClass DBService);
extern PACKAGE void __fastcall UnregisterDBService(System::UnicodeString ServerName);
extern PACKAGE TCustomDBServiceClass __fastcall GetDBServiceByName(System::UnicodeString ServerName);
...
extern PACKAGE void __fastcall RegisterAccessEngine(System::UnicodeString EngineName, TAccessEngineEh* Engine);
extern PACKAGE void __fastcall UnregisterAccessEngine(System::UnicodeString EngineName);
extern PACKAGE TAccessEngineEh* __fastcall GetAccessEngineByName(System::UnicodeString EngineName);
...
extern PACKAGE void __fastcall RegisterDBServiceEngine(TAccessEngineEh* AccessEngine, TCustomDBServiceClass DBService);
extern PACKAGE void __fastcall UnregisterDBServiceEngine(TCustomDBServiceClass DBService);
...
extern PACKAGE void __fastcall RegisterDesignDataBaseClass(System::UnicodeString EngineName, TDesignDataBaseClassEh DesignDBClass);
extern PACKAGE void __fastcall UnregisterDesignDataBaseClass(System::UnicodeString EngineName);
extern PACKAGE TDesignDataBaseClassEh __fastcall GetDesignDataBaseClassByName(System::UnicodeString EngineName);
extern PACKAGE TDesignDataBaseClassEh __fastcall GUISelectDesignDataBaseClass(void);
