...
// (DO NOT EDIT: machine generated header) 'Dbctrlseh.pas' rev: 21.00
...
__interface  INTERFACE_UUID("{4BE708F1-4EA2-4AC7-BA64-89D7D2B83E09}") IInplaceEditHolderEh  : public System::IInterface 
{
...
public:
	...
	virtual void __fastcall InplaceEditKeyDown(Controls::TWinControl* Control, System::Word &Key, Classes::TShiftState Shift) = 0 ;
	virtual void __fastcall InplaceEditKeyPress(Controls::TWinControl* Control, System::WideChar &Key) = 0 ;
	virtual void __fastcall InplaceEditKeyUp(Controls::TWinControl* Control, System::Word &Key, Classes::TShiftState Shift) = 0 ;
};

__interface IInplaceEditEh;
typedef System::DelphiInterface<IInplaceEditEh> _di_IInplaceEditEh;
__interface  INTERFACE_UUID("{81F0C558-B001-4477-BAA6-2DC373FCDF88}") IInplaceEditEh  : public System::IInterface 
{
...
private:
	Toolctrlseh::TFieldsArrEh FFields;
...
public:
	System::Variant DataIndependentValue;
	...
	void __fastcall SetText(System::UnicodeString Text);
...
private:
	...
	Types::TRect __fastcall ImageRect(void);
	...
	HIDESBASE void __fastcall SetEditMask(const System::UnicodeString Value);
	...
	HIDESBASE void __fastcall SetPasswordChar(const System::WideChar Value);
...
protected:
	...
	int FDownButton;
	bool FDroppedDown;
	Toolctrlseh::TEditButtonControlList FEditButtonControlList;
	bool FFocused;
	int FImageWidth;
	...
	Types::TRect __fastcall EditRect(void);
	...
	void __fastcall CheckInplaceEditHolderKeyDown(System::Word &Key, Classes::TShiftState Shift);
	void __fastcall CheckInplaceEditHolderKeyPress(System::WideChar &Key);
	void __fastcall CheckInplaceEditHolderKeyUp(System::Word &Key, Classes::TShiftState Shift);
	...
	virtual void __fastcall EditingChanged(void);
	virtual void __fastcall FilterMRUItem(System::UnicodeString AText, bool &Accept);
	...
	void __fastcall SetControlEditMask(System::UnicodeString Value);
	...
	virtual void __fastcall SetVariantValue(const System::Variant &VariantValue);
...
public:
	...
	__property Db::TDataSource* DataSource = {read=GetDataSource, write=SetDataSource};
	__property System::UnicodeString DisplayTextForPaintCopy = {read=GetDisplayTextForPaintCopy};
	__property System::UnicodeString EditMask = {read=GetEditMask, write=SetEditMask, stored=false};
	__property Db::TField* Field = {read=GetField};
...
private:
	...
	void *__IInplaceEditEh;	/* IInplaceEditEh */
...
public:
	...
	#endif
	#if defined(MANAGED_INTERFACE_OPERATORS)
	operator Toolctrlseh::_di_IComboEditEh()
	{
		Toolctrlseh::_di_IComboEditEh intf;
		GetInterface(intf);
		return intf;
	}
	#else
	...
	#endif
	#if defined(MANAGED_INTERFACE_OPERATORS)
	operator _di_IInplaceEditEh()
	{
		_di_IInplaceEditEh intf;
		GetInterface(intf);
		return intf;
	}
	#else
...
protected:
	...
	void __fastcall InternalSetControlText(System::UnicodeString AText);
	virtual void __fastcall InternalSetText(System::UnicodeString AText);
	virtual void __fastcall InternalSetValue(const System::Variant &AValue);
	virtual void __fastcall InternalUpdatePostData(void);
	DYNAMIC void __fastcall KeyDown(System::Word &Key, Classes::TShiftState Shift);
...
public:
	...
	System::UnicodeString __fastcall DateTimeFormat(void);
	virtual void __fastcall CloseUp(bool Accept);
	virtual void __fastcall DropDown(void);
	...
	__property System::UnicodeString EditFormat = {read=FEditFormat, write=SetEditFormat, stored=false};
...
private:
	...
	Controls::TWinControlClass FPopupListboxClass;
...
protected:
	int FItemsCount;
	bool FKeyBased;
	System::Variant FVarValue;
	int FDefaultItemIndex;
	System::UnicodeString __fastcall ConvertDataText(const System::UnicodeString Value);
	virtual TDropDownBoxEh* __fastcall CreateDropDownBox(void);
	virtual Toolctrlseh::TEditButtonEh* __fastcall CreateEditButton(void);
	virtual Classes::TAlignment __fastcall DefaultAlignment(void);
	virtual int __fastcall DefaultImageIndex(void);
	DYNAMIC bool __fastcall DoMouseWheelDown(Classes::TShiftState Shift, const Types::TPoint &MousePos);
	...
	virtual bool __fastcall ProcessSearchStr(System::UnicodeString Str);
...
public:
	...
	__property Controls::TWinControlClass PopupListboxClass = {read=FPopupListboxClass, write=FPopupListboxClass};
...
private:
	...
	System::UnicodeString __fastcall DisplayFormatToEditFormat(const System::UnicodeString AFormat);
	bool __fastcall GetCurrency(void);
	System::UnicodeString __fastcall GetDisplayFormat(void);
	System::Extended __fastcall GetMaxValue(void);
	System::Extended __fastcall GetMinValue(void);
...
protected:
	...
	System::UnicodeString __fastcall DefaultDisplayFormat(void);
	System::Extended __fastcall DefaultMaxValue(void);
	System::Extended __fastcall DefaultMinValue(void);
	DYNAMIC bool __fastcall DoMouseWheelDown(Classes::TShiftState Shift, const Types::TPoint &MousePos);
	DYNAMIC bool __fastcall DoMouseWheelUp(Classes::TShiftState Shift, const Types::TPoint &MousePos);
	...
	DYNAMIC void __fastcall KeyDown(System::Word &Key, Classes::TShiftState Shift);
	DYNAMIC void __fastcall KeyPress(System::WideChar &Key);
	DYNAMIC void __fastcall ReformatEditText(System::UnicodeString NewText);
	void __fastcall UpdateValueFromText(void);
	virtual void __fastcall WndProc(Messages::TMessage &Message);
	...
	__property MaxLength = {default=0};
	__property System::Extended MaxValue = {read=GetMaxValue, write=SetMaxValue, stored=IsMaxValueStored};
	__property System::Extended MinValue = {read=GetMinValue, write=SetMinValue, stored=IsMinValueStored};
...
extern PACKAGE bool OldStyleFlatBorder;
