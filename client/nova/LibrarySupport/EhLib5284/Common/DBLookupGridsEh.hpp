...
// (DO NOT EDIT: machine generated header) 'Dblookupgridseh.pas' rev: 21.00
...
protected:
	...
	System::UnicodeString __fastcall DefaultText(void);
...
protected:
	...
	virtual Dbgrideh::TColumnDefValuesEh* __fastcall CreateColumnDefValues(void);
	virtual Dbgrideh::TDBGridColumnsEh* __fastcall CreateColumns(void);
...
public:
	...
	HIDESBASE Types::TRect __fastcall DataRect(void);
...
public:
	/* TCustomDBGridEh.CreateNew */ inline __fastcall virtual TDBLookupGridEh(Classes::TComponent* AOwner, int Dummy) : Dbgrideh::TCustomDBGridEh(AOwner, Dummy) { }
...
public:
	/* TCustomDBGridEh.CreateNew */ inline __fastcall virtual TPopupDataGridEh(Classes::TComponent* AOwner, int Dummy) : TDBLookupGridEh(AOwner, Dummy) { }
