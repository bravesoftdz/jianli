...
extern PACKAGE System::WideChar __fastcall CharAtPos(System::UnicodeString S, int Pos);
extern PACKAGE bool __fastcall ParseSTFilterExpressionEh(System::UnicodeString Exp, Dbgrideh::TSTFilterExpressionEh &FExpression, Dbgrideh::TSTFilterDefaultOperatorEh DefaultOperator);
