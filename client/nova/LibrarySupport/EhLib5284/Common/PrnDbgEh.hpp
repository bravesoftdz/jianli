...
// (DO NOT EDIT: machine generated header) 'Prndbgeh.pas' rev: 21.00
...
private:
	...
	System::UnicodeString FPrintFontName;
	...
	int __fastcall GridTextReplace(Classes::TStrings* RichStrings, const System::UnicodeString SearchStr, const System::UnicodeString ReplaceStr, int StartPos, int Length, Comctrls::TSearchTypes Options, bool ReplaceAll);
	...
	void __fastcall SetPrintFontName(const System::UnicodeString Value);
...
__published:
	...
	__property System::UnicodeString PrintFontName = {read=FPrintFontName, write=SetPrintFontName};
