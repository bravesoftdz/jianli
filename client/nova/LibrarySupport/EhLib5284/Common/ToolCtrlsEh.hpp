...
// (DO NOT EDIT: machine generated header) 'Toolctrlseh.pas' rev: 21.00
...
#pragma option push -b-
enum TSortOrderEh { soAscEh, soDescEh };
#pragma option pop
...
__interface  INTERFACE_UUID("{28F8194C-5FF3-42C4-87A6-8B3E06210FA6}") IMemTableDataFieldValueListEh  : public System::IInterface 
{
	
public:
	virtual Classes::TStrings* __fastcall GetValues(void) = 0 ;
	virtual void __fastcall SetFilter(System::UnicodeString Filter) = 0 ;
};

__interface IComboEditEh;
typedef System::DelphiInterface<IComboEditEh> _di_IComboEditEh;
__interface  INTERFACE_UUID("{B64255B5-386A-4524-8BC7-7F49DDB410F4}") IComboEditEh  : public System::IInterface 
{
...
typedef void __fastcall (__closure *TNotInListEventEh)(System::TObject* Sender, System::UnicodeString NewText, bool &RecheckInList);
...
private:
	typedef DynamicArray<DynamicArray<System::Byte> > _TBMListEh__1;
	
	
public:
	Sysutils::TBytes operator[](int Index) { return Items[Index]; }
	
private:
	Sysutils::TBytes FCache;
	bool FCacheFind;
	int FCacheIndex;
	bool FLinkActive;
	int __fastcall GetCount(void);
	bool __fastcall GetCurrentRowSelected(void);
	Sysutils::TBytes __fastcall GetItem(int Index);
	void __fastcall QuickSort(Db::TDataSet* DataSet, int L, int R, TBMListSortCompare SCompare);
	void __fastcall SetItem(int Index, Sysutils::TBytes Item);
	
protected:
	_TBMListEh__1 FList;
	int __fastcall Compare(const Sysutils::TBytes Item1, const Sysutils::TBytes Item2);
	Sysutils::TBytes __fastcall CurrentRow(void);
	virtual Db::TDataSet* __fastcall GetDataSet(void);
	virtual void __fastcall Invalidate(void);
	void __fastcall LinkActive(bool Value);
	virtual void __fastcall RaiseBMListError(const System::UnicodeString S);
...
public:
	...
	bool __fastcall Find(const Sysutils::TBytes Item, int &Index);
	int __fastcall IndexOf(const Sysutils::TBytes Item);
	bool __fastcall Refresh(void);
	void __fastcall AppendItem(Sysutils::TBytes Item);
	...
	void __fastcall InsertItem(int Index, Sysutils::TBytes Item);
	...
	__property Sysutils::TBytes Items[int Index] = {read=GetItem, write=SetItem/*, default*/};
};


__interface IMemTableEh;
typedef System::DelphiInterface<IMemTableEh> _di_IMemTableEh;
__interface  INTERFACE_UUID("{A8C3C87A-E556-4BDB-B8A7-5B33497D1624}") IMemTableEh  : public System::IInterface 
{
...
public:
	...
	virtual int __fastcall InstantReadIndexOfBookmark(Sysutils::TBytes Bookmark) = 0 ;
	...
	virtual _di_IMemTableDataFieldValueListEh __fastcall GetFieldValueList(System::UnicodeString FieldName) = 0 ;
...
__interface  INTERFACE_UUID("{60C6C1A2-A817-4043-885A-BDDC750587BD}") IMTEventReceiverEh  : public System::IInterface 
{
...
public:
	...
	DYNAMIC TEditButtonActionLinkEhClass __fastcall GetActionLinkClass(void);
...
public:
	__fastcall TEditButtonsEh(Classes::TPersistent* Owner, TEditButtonEhClass EditButtonClass);
...
private:
	...
	System::UnicodeString FCellsText;
	...
	bool FVisible;
	System::UnicodeString __fastcall GetCellText(int Index);
	...
	void __fastcall SetCellsText(const System::UnicodeString Value);
...
public:
	...
	bool __fastcall LocateKey(const System::Variant &KeyValue);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	void __fastcall BeginUpdate(void);
	void __fastcall EndUpdate(void);
	__property System::UnicodeString CellText[int Index] = {read=GetCellText};
	__property bool Selected = {read=FSelected, write=FSelected, nodefault};
	__property int UpdateCount = {read=FUpdateCount, nodefault};
	__property Classes::TNotifyEvent OnChanged = {read=FOnChanged, write=FOnChanged};
	
__published:
	__property System::UnicodeString CellsText = {read=FCellsText, write=SetCellsText};
...
protected:
	...
	DYNAMIC void __fastcall MouseUp(Controls::TMouseButton Button, Classes::TShiftState Shift, int X, int Y);
	void __fastcall UpdateBorderWidth(void);
	virtual void __fastcall SelfOnGetData(Controls::TWinControl* Control, int Index, System::UnicodeString &Data);
	virtual void __fastcall SelfOnGetDataObject(Controls::TWinControl* Control, int Index, System::TObject* &DataObject);
...
public:
	...
	virtual void __fastcall DefaultDrawItem(int Index, const Types::TRect &ARect, Windows::TOwnerDrawState State);
	void __fastcall InvalidateIndex(int AItemIndex);
	virtual void __fastcall SetBounds(int ALeft, int ATop, int AWidth, int AHeight);
	__property int BorderWidth = {read=FBorderWidth, nodefault};
	__property Color = {default=-16777211};
	__property Ctl3D;
	__property Font;
	...
	__property bool IsMouseUpCloseListbox = {read=FIsMouseUpCloseListbox, nodefault};
	...
	__property bool UseItemObjects = {read=FUseItemObjects, write=FUseItemObjects, nodefault};
...
class DELPHICLASS TPopupListboxItemEh;
class PASCALIMPLEMENTATION TPopupListboxItemEh : public System::TObject
{
	typedef System::TObject inherited;
	
protected:
	virtual bool __fastcall CanFocus(TPopupListboxEh* Sender, int ItemIndex);
	virtual void __fastcall DrawItem(TPopupListboxEh* Sender, int ItemIndex, const Types::TRect &ARect, Windows::TOwnerDrawState State);
	virtual void __fastcall MouseDown(TPopupListboxEh* Sender, int ItemIndex, const Types::TPoint &InItemPos, Controls::TMouseButton Button, Classes::TShiftState Shift);
	virtual void __fastcall MouseMove(TPopupListboxEh* Sender, int ItemIndex, const Types::TPoint &InItemPos, Classes::TShiftState Shift);
	virtual void __fastcall MouseUp(TPopupListboxEh* Sender, int ItemIndex, const Types::TPoint &InItemPos, Controls::TMouseButton Button, Classes::TShiftState Shift, bool &IsCloseListbox);
	virtual void __fastcall KeyPress(TPopupListboxEh* Sender, int ItemIndex, System::WideChar &Key, Classes::TShiftState Shift, bool &IsCloseListbox);
	
public:
	virtual bool __fastcall CloseOnExecute(TPopupListboxEh* Sender, int ItemIndex);
	virtual void __fastcall Execute(TPopupListboxEh* Sender, int ItemIndex, const Types::TPoint &InItemPos, Classes::TShiftState Shift);
public:
	/* TObject.Create */ inline __fastcall TPopupListboxItemEh(void) : System::TObject() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TPopupListboxItemEh(void) { }
...
public:
	...
	void __fastcall Add(System::UnicodeString s);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	virtual void __fastcall CloseUp(bool Accept);
	virtual void __fastcall DropDown(void);
	bool __fastcall FilterItemsTo(Classes::TStrings* FilteredItems, System::UnicodeString MaskText);
...
public:
	/* TStringList.Create */ inline __fastcall TStringListEh(void)/* overload */ : Classes::TStringList() { }
...
public:
	...
	void __fastcall SetFilter(System::UnicodeString Filter);
...
private:
	void *__IMemTableDataFieldValueListEh;	/* IMemTableDataFieldValueListEh */
	
public:
	#if defined(MANAGED_INTERFACE_OPERATORS)
	operator _di_IMemTableDataFieldValueListEh()
	{
		_di_IMemTableDataFieldValueListEh intf;
		GetInterface(intf);
		return intf;
	}
	#else
...
public:
	...
	virtual Classes::TCollectionItemClass __fastcall GetDesignInfoItemClass(void) = 0 ;
...
typedef bool __fastcall (__closure *TLocateTextEventEh)(System::TObject* Sender, const System::UnicodeString FieldName, const System::UnicodeString Text, TLocateTextOptionsEh Options, TLocateTextDirectionEh Direction, TLocateTextMatchingEh Matching, TLocateTextTreeFindRangeEh TreeFindRange);
...
extern PACKAGE System::UnicodeString EhLibRegKey;
static const Word cm_SetSizeGripChangePosition = 0x464;
static const Word CM_CLOSEUPEH = 0x465;
extern PACKAGE TPopupListboxItemEh* DummyPopupListboxItemEh;
...
extern PACKAGE int DefaultFlatCheckBoxWidth;
extern PACKAGE int DefaultFlatCheckBoxHeight;
extern PACKAGE void __fastcall BroadcastPerformMessageFor(Classes::TComponent* Owner, Controls::TControlClass ForClass, unsigned Msg, int WParam, int LParam);
...
extern PACKAGE Variants::TVariantRelationship __fastcall DBVarCompareValue(const System::Variant &A, const System::Variant &B);
...
extern PACKAGE void __fastcall GetFieldsProperty(Classes::TList* List, Db::TDataSet* DataSet, Classes::TComponent* Control, const System::UnicodeString FieldNames)/* overload */;
extern PACKAGE TFieldsArrEh __fastcall GetFieldsProperty(Db::TDataSet* DataSet, Classes::TComponent* Control, const System::UnicodeString FieldNames)/* overload */;
extern PACKAGE void __fastcall DataSetSetFieldValues(Db::TDataSet* DataSet, System::UnicodeString Fields, const System::Variant &Value);
...
extern PACKAGE bool __fastcall IsFieldTypeNumeric(Db::TFieldType FieldType);
