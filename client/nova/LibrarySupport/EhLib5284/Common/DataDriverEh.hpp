...
// (DO NOT EDIT: machine generated header) 'Datadrivereh.pas' rev: 21.00
...
__interface  INTERFACE_UUID("{E390BBF2-666F-43D7-8CC8-1FA2BA8263D1}") IDataDriverConsumerEh  : public System::IInterface 
{
...
private:
	void *__IDataDriverConsumerEh;	/* IDataDriverConsumerEh */
...
public:
	...
	#endif
	#if defined(MANAGED_INTERFACE_OPERATORS)
	operator _di_IDataDriverConsumerEh()
	{
		_di_IDataDriverConsumerEh intf;
		GetInterface(intf);
		return intf;
	}
	#else
...
private:
	...
	System::UnicodeString FUpdateTable;
	System::UnicodeString FUpdateFields;
	System::UnicodeString FKeyFields;
	bool FSkipUnchangedFields;
	TDynaSQLOptionsEh FOptions;
	void __fastcall SetKeyFields(const System::UnicodeString Value);
	void __fastcall SetUpdateFields(const System::UnicodeString Value);
	void __fastcall SetUpdateTable(const System::UnicodeString Value);
...
__published:
	__property System::UnicodeString KeyFields = {read=FKeyFields, write=SetKeyFields};
	__property System::UnicodeString UpdateFields = {read=FUpdateFields, write=SetUpdateFields};
	__property System::UnicodeString UpdateTable = {read=FUpdateTable, write=SetUpdateTable};
...
protected:
	virtual void __fastcall GenWhereClause(System::UnicodeString KeyFields, Classes::TStrings* SQL);
...
__interface  INTERFACE_UUID("{01F477A4-8417-4DC9-B93A-1F95D2FF2EB8}") IDesignDataBaseEh  : public System::IInterface 
{
...
public:
	...
	virtual bool __fastcall GetFieldList(const System::UnicodeString TableName, Db::TDataSet* DataSet) = 0 ;
...
extern PACKAGE void __fastcall VarParamsToParams(const System::Variant &VarParams, Db::TParams* Params);
extern PACKAGE void __fastcall RegisterDesignDataBuilderProcEh(TSQLDataDriverEhClass DataDriverClass, TSetDesignDataBaseProcEh DesignDataBaseProc);
extern PACKAGE void __fastcall UnregisterDesignDataBuilderProcEh(TSQLDataDriverEhClass DataDriverClass);
extern PACKAGE TSetDesignDataBaseProcEh __fastcall GetDesignDataBuilderProcEh(TSQLDataDriverEhClass DataDriverClass);
