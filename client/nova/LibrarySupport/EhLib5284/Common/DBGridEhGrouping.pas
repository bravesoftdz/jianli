...
{                      Build 5.2.05                     }
{                                                       }
{      Copyright (c) 2001-2010 by Dmitry V. Bolshakov   }
{                                                       }
{*******************************************************}
...
{ TGridGroupDataTreeEh }
  ...
  public
    ...
    destructor Destroy; override;
    function AddRecordNodeForKey(AKey: Variant): TGroupDataTreeNodeEh;
...
function TGridGroupDataTreeEh.AddRecordNodeForKey(AKey: Variant): TGroupDataTreeNodeEh;
var
  k{, j}: Integer;
  Key1: Variant;
  ...
  try
    ...
    begin
      ...
      try
        ...
        RecNode := AddRecordNodeForKey(KeyValue);
