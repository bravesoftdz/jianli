...
// (DO NOT EDIT: machine generated header) 'Prvieweh.pas' rev: 21.00
...
protected:
	...
	virtual void __fastcall SetTitle(const System::UnicodeString Value);
...
public:
	...
	virtual void __fastcall GetPrinter(System::WideChar * ADevice, System::WideChar * ADriver, System::WideChar * APort, unsigned &ADeviceMode);
	virtual void __fastcall SetPrinter(System::WideChar * ADevice, System::WideChar * ADriver, System::WideChar * APort, unsigned ADeviceMode);
