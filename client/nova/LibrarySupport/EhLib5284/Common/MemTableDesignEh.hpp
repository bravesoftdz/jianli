...
// (DO NOT EDIT: machine generated header) 'Memtabledesigneh.pas' rev: 21.00
...
protected:
	virtual Dsdesign::TDSDesignerClass __fastcall GetDSDesignerClass(void);
...
extern PACKAGE void __fastcall ShowFieldsEditorEh(Designintf::_di_IDesigner Designer, Db::TDataSet* ADataset, Dsdesign::TDSDesignerClass DesignerClass);
extern PACKAGE Dsdesign::TFieldsEditor* __fastcall CreateFieldsEditorEh(Designintf::_di_IDesigner Designer, Db::TDataSet* ADataset, Dsdesign::TDSDesignerClass DesignerClass, bool &Shared);
