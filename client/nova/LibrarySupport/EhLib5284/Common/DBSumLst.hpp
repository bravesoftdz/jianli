...
// (DO NOT EDIT: machine generated header) 'Dbsumlst.pas' rev: 21.00
...
public:
	TDBSum* __fastcall GetSumByOpAndFName(TGroupOperation AGroupOperation, System::UnicodeString AFieldName);
	__property TDBSum* Items[int Index] = {read=GetItem, write=SetItem/*, default*/};
public:
	/* TCollection.Create */ inline __fastcall TDBSumCollection(Classes::TCollectionItemClass ItemClass) : Classes::TCollection(ItemClass) { }
...
protected:
	...
	virtual int __fastcall FindVirtualRecord(Sysutils::TBytes Bookmark);
	DYNAMIC Classes::TPersistent* __fastcall GetOwner(void);
...
private:
	...
	Classes::TNotifyEvent __fastcall GetOnAfterRecalcAll(void);
	Classes::TNotifyEvent __fastcall GetOnRecalcAll(void);
	int __fastcall GetRecNo(void);
	TDBSumCollection* __fastcall GetSumCollection(void);
	Classes::TNotifyEvent __fastcall GetSumListChanged(void);
