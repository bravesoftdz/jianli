...
// (DO NOT EDIT: machine generated header) 'Calculatoreh.pas' rev: 21.00
...
private:
	...
	System::Extended __fastcall GetDisplayValue(void);
	...
	void __fastcall SetDisplayValue(const System::Extended Value);
...
public:
	...
	virtual void __fastcall ProcessKey(System::WideChar Key);
	__property System::UnicodeString DisplayText = {read=GetDisplayText, write=SetDisplayText};
	__property System::Extended DisplayValue = {read=GetDisplayValue, write=SetDisplayValue};
...
__interface  INTERFACE_UUID("{697F81AD-0E0F-4A4A-A016-A713620660DE}") IPopupCalculatorEh  : public System::IInterface 
{
...
private:
	void *__IPopupCalculatorEh;	/* IPopupCalculatorEh */
...
public:
	...
	#endif
	#if defined(MANAGED_INTERFACE_OPERATORS)
	operator _di_IPopupCalculatorEh()
	{
		_di_IPopupCalculatorEh intf;
		GetInterface(intf);
		return intf;
	}
	#else
