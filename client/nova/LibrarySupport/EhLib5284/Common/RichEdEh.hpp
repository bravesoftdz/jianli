...
// (DO NOT EDIT: machine generated header) 'Richedeh.pas' rev: 21.00
...
__published:
	...
	void __fastcall EditorKeyDown(System::TObject* Sender, System::Word &Key, Classes::TShiftState Shift);
...
private:
	...
	void __fastcall PerformFileOpen(const System::UnicodeString AFileName);
