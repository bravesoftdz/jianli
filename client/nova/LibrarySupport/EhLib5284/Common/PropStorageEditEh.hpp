...
// (DO NOT EDIT: machine generated header) 'Propstorageediteh.pas' rev: 21.00
...
protected:
	Comctrls::TTreeNode* __fastcall AddSortedChildObject(Comctrls::TTreeNode* Parent, const System::UnicodeString S, TNodeInfoEh* Data);
	...
	TNodeInfoEh* __fastcall CreateNodeInfo(Classes::TComponent* Component, System::UnicodeString Name, System::UnicodeString Path, TNodeTypeEh NodeType, bool IsVoidProperty);
	Comctrls::TTreeNode* __fastcall FindChildNodeInfo(Comctrls::TTreeNode* N2, Comctrls::TTreeNode* N1);
	Comctrls::TTreeNode* __fastcall GetChildNodeByText(Comctrls::TTreeNode* ParentNode, System::UnicodeString Text);
	...
	void __fastcall AddCollectionProperties(Comctrls::TTreeNode* N, Classes::TCollection* O, System::UnicodeString Path);
	void __fastcall AddComponents(Comctrls::TTreeNode* N, Classes::TComponent* O, System::UnicodeString Path);
	void __fastcall AddParentChecked(Comctrls::TTreeNode* N);
	void __fastcall AddProperties(Comctrls::TTreeNode* N, System::TObject* O, System::UnicodeString Path, bool IsAddPropNode);
	...
	void __fastcall MainAddPropertyNode(System::UnicodeString Path)/* overload */;
	void __fastcall MainDeletePropertyNode(Comctrls::TTreeNode* N)/* overload */;
	void __fastcall MainDeletePropertyNode(System::UnicodeString Path)/* overload */;
...
protected:
	...
	virtual bool __fastcall PropertyAdded(Classes::TComponent* Component, System::UnicodeString PropPath);
	virtual bool __fastcall PropertyDeleted(Classes::TComponent* Component, System::UnicodeString PropPath);
...
extern PACKAGE void __fastcall RegisterPredifinedPropsClass(TPredifinedPropsEhClass PropsClass);
