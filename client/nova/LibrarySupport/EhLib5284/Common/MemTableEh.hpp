...
public:
	...
	System::Variant __fastcall GetOldValue(Db::TField* Field);
	...
	__property System::Variant OldValue[Db::TField* Field] = {read=GetOldValue};
...
public:
	__fastcall TMemTableDataFieldValueListEh(Db::TDataSet* ADataSet);
