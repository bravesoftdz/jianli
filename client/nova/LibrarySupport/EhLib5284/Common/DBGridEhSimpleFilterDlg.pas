...
{                     Build 5.2.03                      }
{                                                       }
{     Copyright (c) 2009 by Dmitry V. Bolshakov         }
{                                                       }
{*******************************************************}
...
begin
  FillDialogFromColumnFilter1(
    STFilter.Expression.Operator1, STFilter.Expression.Operand1,
    ComboBox1, DBComboBoxEh1
    );
  rbOr.Checked := (STFilter.Expression.Relation = foOR);
  rbAnd.Checked := not rbOr.Checked;
  FillDialogFromColumnFilter1(
    STFilter.Expression.Operator2, STFilter.Expression.Operand2,
