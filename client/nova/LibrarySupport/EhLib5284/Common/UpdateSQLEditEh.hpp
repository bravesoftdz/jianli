...
// (DO NOT EDIT: machine generated header) 'Updatesqlediteh.pas' rev: 21.00
...
__published:
	...
	void __fastcall MemoModifyKeyDown(System::TObject* Sender, System::Word &Key, Classes::TShiftState Shift);
	
private:
	Datadrivereh::TCustomSQLDataDriverEh* DataDriver;
	bool FSettingsChanged;
	bool FDatasetDefaults;
	System::UnicodeString __fastcall GetTableRef(const System::UnicodeString TabName, const System::UnicodeString QuoteChar);
	bool __fastcall Edit(void);
	void __fastcall GenWhereClause(const System::UnicodeString TabAlias, const System::UnicodeString QuoteChar, Classes::TStrings* KeyFields, Classes::TStrings* SQL);
	void __fastcall GenDeleteSQL(const System::UnicodeString TableName, const System::UnicodeString QuoteChar, Classes::TStrings* KeyFields, Classes::TStrings* SQL);
	void __fastcall GenInsertSQL(const System::UnicodeString TableName, const System::UnicodeString QuoteChar, Classes::TStrings* UpdateFields, Classes::TStrings* SQL);
	void __fastcall GenModifySQL(const System::UnicodeString TableName, const System::UnicodeString QuoteChar, Classes::TStrings* KeyFields, Classes::TStrings* UpdateFields, Classes::TStrings* SQL);
...
public:
	__fastcall TSQLParser(const System::UnicodeString Text);
	void __fastcall GetSelectTableNames(Classes::TStrings* List);
	void __fastcall GetUpdateTableName(System::UnicodeString &TableName);
