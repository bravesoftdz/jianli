...
// (DO NOT EDIT: machine generated header) 'Memtreeeh.pas' rev: 21.00
...
public:
	TBaseTreeNodeEh* operator[](const int Index) { return Items[Index]; }
...
protected:
	...
	__property TBaseTreeNodeEh* Items[const int Index] = {read=GetItem/*, default*/};
	...
	__property TBaseTreeNodeEh* VisibleItem[const int Index] = {read=GetVisibleItem};
...
public:
	__fastcall TTreeListEh(TTreeNodeClassEh ItemClass);
	__fastcall virtual ~TTreeListEh(void);
	TBaseTreeNodeEh* __fastcall AddChild(const System::UnicodeString Text, TBaseTreeNodeEh* Parent, System::TObject* Data);
	...
	TBaseTreeNodeEh* __fastcall CreateNodeApart(const System::UnicodeString Text, System::TObject* Data);
	...
	void __fastcall ExtractNode(TBaseTreeNodeEh* Node, bool ReIndex);
