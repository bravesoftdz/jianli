...
// (DO NOT EDIT: machine generated header) 'Propfilereh.pas' rev: 21.00
...
typedef void __fastcall (__closure *TReadOwnerPropEventEh)(TPropReaderEh* Reader, System::UnicodeString PropName, bool &Processed);
...
public:
	...
	HIDESBASE void __fastcall WritePropName(const System::UnicodeString PropName);
	virtual void __fastcall DefineBinaryProperty(const System::UnicodeString Name, Classes::TStreamProc ReadData, Classes::TStreamProc WriteData, bool HasData);
	void __fastcall DefineObjectProperties(System::TObject* Instance);
	virtual void __fastcall DefineProperty(const System::UnicodeString Name, Classes::TReaderProc ReadData, Classes::TWriterProc WriteData, bool HasData);
	void __fastcall SaveObjectProperyValue(System::TObject* Instance, System::UnicodeString Path, System::UnicodeString FullPath);
...
public:
	...
	virtual void __fastcall Readed(void);
	Types::TRect __fastcall GetNotmalFormPlacement(void);
...
extern PACKAGE Classes::TComponent* __fastcall FindChildComponent(Classes::TComponent* ParentComp, Classes::TComponent* Root, const System::UnicodeString AName, bool CheckInline);
extern PACKAGE System::UnicodeString __fastcall GetNextPointSeparatedToken(System::UnicodeString Path);
extern PACKAGE void __fastcall RegisterReadPropertyInterceptor(System::TClass Target, TReadPropertyInterceptorClass Interceptor);
extern PACKAGE void __fastcall UnregisterReadPropertyInterceptor(System::TClass Target, TReadPropertyInterceptorClass Interceptor);
extern PACKAGE TReadPropertyInterceptorClass __fastcall GetInterceptorForTarget(System::TClass Target);
