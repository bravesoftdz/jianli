inherited frmOnecardscheduleEdit: TfrmOnecardscheduleEdit
  Caption = #32534#36753#19968#21345#36890#21442#19982#29677#27425
  ClientHeight = 404
  ClientWidth = 657
  OnCreate = FormCreate
  ExplicitWidth = 663
  ...
  inherited pnlEditBox: TPanel
    ...
    object mmoMeRemark: TMemo
      ...
      Width = 175
      Height = 118
      Hint = #21482#33021#36755#20837'50'#20010#23383
      MaxLength = 50
      TabOrder = 5
    end
  ...
  inherited ImageList: TImageList
    Top = 240
    Bitmap = {
      494C010105000700A00018001800FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object jsdcSave: TjsonClientDataSet
    ...
    QueryAddress = 'archive/saveOnecardschedule'
    SaveAddress = 'archive/saveOnecardschedule'
    AutoActive = False
    ...
    Params = <
      item
        DataType = ftString
        Name = 'onecardschedule.id'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'onecardschedule.orgid'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'onecardschedule.type'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'onecardschedule.createby'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'onecardschedule.createtime'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'onecardschedule.startdate'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'onecardschedule.enddate'
        ParamType = ptInput
      end
      item
        DataType = ftString
        Name = 'onecardschedule.remarks'
        ParamType = ptInput
      end
      item
        DataType = ftString
  ...
  object jcdsSchedule: TjsonClientDataSet
    ...
    QueryAddress = 'archive/findscheduleRouteinfo'
    AutoActive = False
    AutoCopyRecord = False
    AutoCloneData = False
    Aggregates = <>
